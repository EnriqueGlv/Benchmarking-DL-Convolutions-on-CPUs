...
#ifndef CPU_LIP6_CONVOLUTION_DIRECT_HPP
#define CPU_LIP6_CONVOLUTION_DIRECT_HPP
...
struct lip6_convolution_direct_fwd_t : public primitive_t {
    struct pd_t : public cpu_convolution_fwd_pd_t {
        using cpu_convolution_fwd_pd_t::cpu_convolution_fwd_pd_t;

        DECLARE_COMMON_PD_T("lip6:direct", lip6_convolution_direct_fwd_t);
        ...
        status_t init(engine_t *engine) {
            ...
            bool ok = is_fwd()
                    ...
                    && !getenv_int("LIP6_DISABLE_DIRECT", 0)
                    ;
    ...
    lip6_convolution_direct_fwd_t(const pd_t *apd) : primitive_t(apd) {}
